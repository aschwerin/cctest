...
@section('content')
    <div class="container">
        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="{{ url('blog/' . $post->id . '/update') }}">
                {{ method_field('patch')}}
                {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('post_title') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <input id="post_title" type="text" class="form-control" name="post_title" value="{{ $post->post_title }}">
                ...
                <div class="form-group{{ $errors->has('post_content') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea id="post_content" class="form-control" name="post_content" >
                            {!! $post->post_content !!}
                        </textarea>
