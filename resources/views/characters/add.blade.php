...
@section('content')
    <div class="container">
        <div class="panel-body">
            <form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="{{ url('character/create') }}">
            {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-2">
                        <button class="btn btn-primary" id="gen_character">Randomize <i class="fa fa-btn fa-magic"></i></button>
                    </div>
                </div>
                ...
                <div class="form-group{{ $errors->has('background') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea id="background" class="form-control" name="background" ></textarea>
                ...
                <div class="form-group{{ $errors->has('str') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-2">
                        <button class="btn btn-primary" id="gen_stat">Re-Roll <i class="fa fa-btn fa-magic"></i></button>
                    </div>
                </div>
                ...
                <div class="form-group{{ $errors->has('inspiration') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <input id="inspiration" type="text" class="form-control" name="inspiration" value="{{ old('inspiration') }}">
                ...
                <div class="form-group{{ $errors->has('personality_traits') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea id="personality_traits" class="form-control" name="personality_traits" ></textarea>
                ...
                <div class="form-group{{ $errors->has('ideals') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea id="ideals" class="form-control" name="ideals" ></textarea>
                ...
                <div class="form-group{{ $errors->has('bonds') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea id="bonds" class="form-control" name="bonds" ></textarea>
                        @if ($errors->has('bonds'))
                            <span class="help-block">
                ...
                <div class="form-group{{ $errors->has('flaws') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea id="flaws" class="form-control" name="flaws" ></textarea>
                        @if ($errors->has('flaws'))
                            <span class="help-block">
...
//                    $("#div1").html(result);
        ...
        $('#gen_character').click(function (event) {
           event.preventDefault();
           $.ajax({
               url: "{{ url('characters/char_gen') }}",
               delay: 250,
               success: function(result){
